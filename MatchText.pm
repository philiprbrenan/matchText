...
#-------------------------------------------------------------------------------
# Match a question against possible answers
...
#D1                                                                             # Match some text against possible answers
...
MatchText.pm - Match text against possible answers
...
my $localTest = ((caller(1))[0]//'MatchText') eq "MatchText";                   # Local testing mode
